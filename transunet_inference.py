...
class TransformerBlock(tf.keras.layers.Layer):
    def __init__(self, dim, num_heads, **kwargs):
        super(TransformerBlock, self).__init__(**kwargs)  # Pass kwargs to the parent class
...
def main(input_folder, output_folder, model_path):
    ...
    # Add TransformerBlock to custom_objects
    custom_objects = {
        'dice_loss': dice_loss,
        'dice_coefficient': dice_coefficient,
        'iou_score': iou_score,
        'TransformerBlock': TransformerBlock  # Add this line
    }
...
if __name__ == "__main__":
    ...
    model_path = 'C:\\Users\\rasto\\Downloads\\pythonproject\\unet\\logs_trans\\transunet_best_model.keras'
